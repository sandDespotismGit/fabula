      ...
      <View style={styles.main}>
        <View style={styles.headerContainer}>
          ...
          <View style={styles.headerTextEquals}>
            <Text style={styles.headerDesciption}>Настройки</Text>
          </View>
          <View style={styles.headerEquals}>
          </View>
        </View>
        <View style={{display:'flex', flexDirection:'column', justifyContent:'center', minHeight:'80%', alignContent:'center', alignItems:'center'}}>
          <View style={styles.verticalFlex}>
            <Text style={styles.headerText}>
              Настройки...
            </Text>
            <Text style={styles.headerDesciptionNew}>
              ...Могли бы быть здесь, но они еще в разработке
            </Text>
          </View>
        </View>
      </View>
