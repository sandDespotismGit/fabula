...
import base64txt2imgPostRequest, { getFirstAll, getThirdAll } from '../public/api/func/serverApi';
...
const NewPhotoMain = ({navigation}) => {
  ...
  useEffect(() => {
    getFirstAll().then(response => console.log(response))
      ...
      <ScrollView style={styles.mainScroll}>
        ...
        <View
          ...
          <TextInput
            ...
            placeholder="Промпт для замены фона..."
            onChangeText={text => {
              setDepthPrompt(text);
            }}
          />
